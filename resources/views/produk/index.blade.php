    ...
    <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-custom">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                <a class="navbar-brand mt-3 ms-4" href="#">
                    <img src="https://i.postimg.cc/L6q4HSP3/Lunar-Logo-1-removebg-preview.png" width="70%" alt="logo">
                </a>
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start mt-5" id="menu">
                    ...
                    <li class="nav-item mb-3">
                        <a href="{{ url('cek-ongkir') }}" class="me-4">
                        <svg fill="none" class="me-2" stroke="currentColor" stroke-width="1.5" width="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-2.25-2.25l3.276-3.276a4.5 4.5 0 00-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437l1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008z" />
                        </svg>Cek Ongkir</a>
                    </li>
                ...
                <div class="card">
                    <div class="card-header">Data Produk</div>
                        <div id="collapseOne" class="collapse show" data-bs-parent="#accordion">
                            <div class="card-body">
                                <a href="{{ url('/produk/create') }}" class="btn btn-primary btn-sm mb-3" title="Add New Contact"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Data
                                </a>
                                        ...
                                        @foreach($produk as $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img src="{{ asset($item->foto) }}" width= '100' height='100' class="img img-responsive" />
                                                </td>
                                                ...
                                                <td class="text-center">{{ $item->harga_member }}</td>
                                                <td class="text-center">{{ $item->detail }}</td>
                                                <td class="text-center">
                                                    <button class="btn btn-primary btn-sm"><a href="{{ route('produk.edit', $item->id) }}" data-toggle="tooltip" title="Edit Data!"><i class="fa fa-edit text-white"></i></a></button>
