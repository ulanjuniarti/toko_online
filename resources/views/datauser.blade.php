            ...
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start mt-5" id="menu">
                    ...
                    <li class="nav-item mb-3">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="me-2" stroke-width="1.5" width="20" fill="currentColor" viewBox="0 0 16 16">
